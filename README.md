...
Then open <http://127.0.0.1:8777>, <http://127.0.0.1:8778> or
<http://127.0.0.1:8779>. `Ctrl+C` stops any of them.

Optional but worth it: a [Stockfish](https://stockfishchess.org/download/)
binary in `Lichess-Study-to-PDF/engine/` gives all three apps evaluation bars
